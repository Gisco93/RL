...
\begin{answer}
	...
	We are not learning a function with this. This is a problem as there can be many solutions to one problem resulting in difficulties when learning (using the mean doesn't make sense since the mean of two solutions is itself far off).
\end{answer}
